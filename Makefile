...
SRCS =	cd.c echo.c env.c exit.c export.c pwd.c unset.c \
		...
		free_nodelist.c handle_redirects.c pipe_handler.c pipeline.c stdio_fildes.c \
		subshell.c dollar_string_group.c expand_dollar_variable.c filename_expansion.c globbing.c \
		group_subpatterns.c parameter_expansion.c quote_removal.c shell_expansion.c \
		tilde_expansion.c heredoc_handler.c heredoc.c history.c lexer.c token_types.c tokenizer.c \
		tokenlist.c output_error.c syntax_error.c node_types.c nodelist.c parser.c redirections.c \
